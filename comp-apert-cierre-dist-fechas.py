...
# Fetch data for Date 1 using the next available trading date
try:
    data_date_1 = fetch_trading_data(tickers, selected_date_1, mode="next")
    data_date_2 = fetch_trading_data(tickers, selected_date_2, mode="previous")
